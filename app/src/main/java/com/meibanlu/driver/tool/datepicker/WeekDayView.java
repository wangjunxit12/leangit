...
public class WeekDayView extends View {
    //上横线颜色
    private int mTopLineColor = Color.parseColor("#F9BF2F");
    //下横线颜色
    private int mBottomLineColor = Color.parseColor("#F9BF2F");
    //周一到周五的颜色
    private int mWeedayColor = Color.parseColor("#989898");
    //周六、周日的颜色
    private int mWeekendColor = Color.parseColor("#989898");
    //线的宽度
