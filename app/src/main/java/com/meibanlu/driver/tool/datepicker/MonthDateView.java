...
public class MonthDateView extends View {
    ...
    private int mSelectBGColor = Color.parseColor("#FD8900");
    private int mCurrentColor = Color.parseColor("#ffffff");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int day = 0; day < mMonthDays; day++) {
            ...
            if (dayString.equals(mSelDay + "")) {
                ...
                int size = UtilTool.dip2px(context, 16);
                canvas.drawCircle(startRecX + size, startRecY + size, size, mPaint);
                // 记录第几行，即第几周
                weekRow = row + 1;
            }
            // 绘制事务圆形标志
            drawCircle(row, column, mSelYear * 10000 + (mSelMonth + 1) * 100
                    + day + 1, canvas);
            if (dayString.equals(mSelDay + "")) {
    ...
    public String getDate() {
        ...
        return mSelYear + "-" + strMouth + "-" + strDay;
    }
