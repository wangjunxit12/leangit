...
public final class CustomActivityOnCrash {
    ...
    public static String getAllErrorDetailsFromIntent(Context context, Intent intent) {
        ...
        String errorDetails = "";
        String phoneNumber = SharePreData.getInstance().getStrData("phone");
     ...
     * The default is RunActivity.drawable.customactivityoncrash_error_image (a cute upside-down bug).
     */
